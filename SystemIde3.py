...
# Bu kodda gizli katmana y[k-1], y[k-2] ve y[k-3] eklenmiştir.
...
forthFeatureTrain = e[3:123].reshape(-1, 1)         # e[k]
...
elman = RNN(input_dim=1,hidden_dim=3,output_dim=1,act='tanh')

elman.train(x_train,y_train,150,0.05)
plt.figure()
...
forthFeatureTest = e[123:150].reshape(-1, 1)    # e[k]
